...
<Tabs.Root value="Overview" class="space-y-4">
	...
	<Tabs.Content value="Overview" class="space-y-4">
		...
		<p class="mb-4">
			...
			firefighting equipment, enhancing early warning systems, and supporting community preparedness
			programs are crucial steps to mitigate future wildfire risks. Additionally, there was
			significant support for implementing stricter land-use regulations to prevent construction in
			high-risk fire zones, thereby reducing potential damages.
		</p>
		...
		<p class="mb-4">
			...
			natural fire regimes through controlled burns and forest thinning to reduce fuel loads. There
			was also a strong advocacy for addressing climate change as a fundamental factor exacerbating
			wildfire intensity and frequency, suggesting that comprehensive climate policies are integral
			to long-term wildfire mitigation strategies.​
		</p>
		<h2 class="font-bold">Impacts</h2>
		<p class="mb-4">These findings where discussed at a meeting of the disaster recovery group.</p>
		<p class="mb-4">
	...
	<Tabs.Content value="Feedback">
		...
		<article class="article-quote mb-4">
			...
			respond to wildfires, from better land management to stronger rebuilding efforts. However, one
			challenge was translating this collective input into concrete steps for action. While the
			conversation was productive, the next phase should focus on connecting these ideas with
			decision-makers and resources to ensure real-world impact. Future sessions could include more
			direct engagement with policymakers and community leaders to help turn the public’s insights
		...
		<article class="article-quote mb-4">
			...
			had common ground. The Polis tool made it easy to see which ideas had the most support, which
			helped highlight solutions that could actually work for our community.
		</article>

		<article class="article-quote mb-4">
			I noticed that many of the ideas came from people who weren’t directly affected by wildfires.
			It would have been helpful to hear more from those who have lost homes or had to evacuate.
			Their firsthand experiences could have given us deeper insight into what kind of support is
			actually needed after a fire.
		</article>
		<article class="article-quote mb-4">
			This conversation introduced me to perspectives I hadn’t considered before. I came in thinking
			mostly about firefighting strategies, but hearing about controlled burns, land-use policies,
			and community rebuilding efforts helped me understand that wildfire response needs to be about
			long-term prevention too. It felt like a well-rounded and thoughtful discussion.
		</article>

		<article class="article-quote mb-4">
			While the discussion was engaging, I left feeling unsure about what happens next. We talked
			about a lot of great ideas, but I didn’t get a clear sense of how this input would be used or
			if decision-makers were actually paying attention. It would be helpful to have a clearer
