<script lang="ts">
	...
	async function applyTemplate() {
		...
		await invalidate(key('admin/conversation/design/workflow'));
						...
						>
							{#snippet children(step, index)}
								...
								>
									...
									<!-- Actions menu (above the stretched link). All step actions live here to keep the card uncluttered; the whole card is draggable, and Move up/down provide a no-drag reorder path. -->
