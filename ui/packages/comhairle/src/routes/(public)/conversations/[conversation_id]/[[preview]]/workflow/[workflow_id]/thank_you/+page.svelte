...
<div class="prose mx-auto mt-20">
	...
	{#if conversation.showThankYouPageAnnonInstructions}
		...
		{:else}
			<p>
				The conversation is ongoing. When it's done we will email you with a link to the
				results and will follow up with notifications on how those results are used.
			</p>
		{/if}
	{/if}
