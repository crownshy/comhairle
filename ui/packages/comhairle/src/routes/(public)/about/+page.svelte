...
<article class="prose">
	<section>
		...
		<p>
			...
			people to access or influence. Cormhairle enables policymakers to quickly set up
	...
	<section>
		...
		<p>
			...
			intelligence, participatory science, social movements and grassroots organizing. We
			specialize in designing comprehensive, end-to-end systems that elevate and expand
			democratic practices all while prioritizing meaningful human connection.
		</p>
	</section>
</article>
