/**
 * @description Allows you to get the maximum number from an array of objects. Using something like `Math.max(...arr.map())`; Means you have to loop twice, with this you only loop once
 *
