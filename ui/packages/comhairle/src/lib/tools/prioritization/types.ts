...
export type Proposal = {
	...
	/** Resolved strings in the locale that loaded the list. Use these for rendering when you don't need to edit translations. */
	title: string;
	body: string;
	/** Full translation envelopes for editing. Present whenever the adapter fetched proposals with translations (admin flow). */
