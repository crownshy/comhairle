...
export const UpdateUserConversationPreferences = z
	.object({
		...
		receiveSimilarConversationUpdatesByNotification: z.union([z.boolean(), z.null()]),
...
export const ComhairleSessionMessage = z
	.object({
		content: z.string(),
		id: z.string(),
		reference: z.union([z.array(ComhairleMessageReference), z.null()]).optional(),
		role: z.string()
	})
	.passthrough();
...
export const ToolConfig = z.union([
	z
		...
		.passthrough(),
	z.object({ pages: z.array(LearnPageEntry), type: z.literal('learn') }).passthrough(),
	z
		.object({
			admin_password: z.string(),
			admin_user: z.string(),
	...
	z
		...
		.passthrough(),
	z.object({ topic: z.string(), type: z.literal('elicitationbot') }).passthrough()
]);
...
export const EventResponse = z.union([LocalizedEventDto, EventWithTranslations]);
